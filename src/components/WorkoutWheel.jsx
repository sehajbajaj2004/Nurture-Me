...
const WorkoutWheel = () => {
  ...
  const initializeUnity = () => {
    const buildUrl = "WorkoutWheel";
    const loaderUrl = `${buildUrl}/WorkoutWheel.loader.js`;
    const canvas = document.querySelector("#unity-canvas");

    const config = {
      dataUrl: `${buildUrl}/WorkoutWheel.data`,
      frameworkUrl: `${buildUrl}/WorkoutWheel.framework.js`,
      codeUrl: `${buildUrl}/WorkoutWheel.wasm`,
