...
const BreathingTiles = () => {
  ...
  const initializeUnity = () => {
    const buildUrl = "BreathingTiles";
    const loaderUrl = `${buildUrl}/BreathingTiles.loader.js`;
    const canvas = document.querySelector("#unity-canvas");

    const config = {
      dataUrl: `${buildUrl}/BreathingTiles.data`,
      frameworkUrl: `${buildUrl}/BreathingTiles.framework.js`,
      codeUrl: `${buildUrl}/BreathingTiles.wasm`,
